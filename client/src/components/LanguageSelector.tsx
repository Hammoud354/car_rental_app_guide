...
export function LanguageSelector({ isCollapsed = false, compact = false }: LanguageSelectorProps) {
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className="text-gray-600 hover:text-blue-700 hover:bg-blue-50 transition-colors px-2 gap-1.5"
