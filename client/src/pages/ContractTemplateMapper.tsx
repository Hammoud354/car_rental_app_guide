...
const SAMPLE_DATA: Record<string, string> = {
  ...
  clientMotherFullName: "Jane Doe",
  clientFatherFullName: "James Doe",
...
const CONTRACT_FIELDS = [
  ...
  { id: "clientMotherFullName", label: "Client Mother's Full Name" },
  { id: "clientFatherFullName", label: "Client Father's Full Name" },
