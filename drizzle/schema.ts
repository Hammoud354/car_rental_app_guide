...
export const maintenanceTypeEnum = pgEnum("maintenanceType", ["Routine", "Repair", "Inspection", "Emergency", "Oil Change", "Brake Pads Change", "Oil + Filter", "Battery Change", "Lamp / Bulb Change", "Brake Light", "Wiper Blades", "Fuse Replacement", "Tire Inflation / Fix", "AC Recharge", "Oil Top-up", "Minor Adjustment", "Other On-Spot"]);
...
export const companyProfiles = pgTable("companyProfiles", {
  ...
  sidebarColor: varchar("sidebarColor", { length: 20 }),
  faviconUrl: text("faviconUrl"),
  loginWelcomeText: varchar("loginWelcomeText", { length: 500 }),
  loginLogoUrl: text("loginLogoUrl"),
...
export const vehicles = pgTable(
  "vehicles",
  {
    ...
    purchaseType: varchar("purchaseType", { length: 20 }),
    downPayment: decimal("downPayment", { precision: 10, scale: 2 }),
    interestRate: decimal("interestRate", { precision: 5, scale: 2 }),
    monthlyInstallmentAmount: decimal("monthlyInstallmentAmount", { precision: 10, scale: 2 }),
...
export const rentalContracts = pgTable("rentalContracts", {
  ...
  clientMotherFullName: varchar("clientMotherFullName", { length: 200 }),
  clientDriverLicense: varchar("clientDriverLicense", { length: 100 }),
  clientFatherFullName: varchar("clientFatherFullName", { length: 200 }),
  ...
  secondDriverName: varchar("secondDriverName", { length: 200 }),
  secondDriverDateOfBirth: timestamp("secondDriverDateOfBirth"),
  secondDriverLicenseIssueDate: timestamp("secondDriverLicenseIssueDate"),
  secondDriverLicenseExpiryDate: timestamp("secondDriverLicenseExpiryDate"),
