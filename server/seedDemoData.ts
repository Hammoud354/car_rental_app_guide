...
export async function seedDemoData(userId: number): Promise<void> {
  ...
  // Use userId as suffix so plate numbers are unique across concurrent demo sessions
  const p = (plate: string) => `${plate}-${userId}`;

  const vehicleData = [
    { userId, plateNumber: p("ABC-1234"), brand: "Toyota", model: "Camry", year: 2022, color: "Silver", category: "Midsize" as const, status: "Available" as const, dailyRate: "45.00", weeklyRate: "280.00", monthlyRate: "1000.00", mileage: 15000, purchaseCost: "25000.00", insuranceCost: "1200.00", insuranceExpiryDate: new Date(now.getTime() + 90 * 24 * 60 * 60 * 1000), nextMaintenanceDate: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("XYZ-5678"), brand: "Honda", model: "Civic", year: 2023, color: "Blue", category: "Compact" as const, status: "Rented" as const, dailyRate: "40.00", weeklyRate: "250.00", monthlyRate: "900.00", mileage: 8000, purchaseCost: "22000.00", insuranceCost: "1000.00", insuranceExpiryDate: new Date(now.getTime() + 10 * 24 * 60 * 60 * 1000), nextMaintenanceDate: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("DEF-9012"), brand: "Ford", model: "Explorer", year: 2021, color: "Black", category: "SUV" as const, status: "Available" as const, dailyRate: "65.00", weeklyRate: "400.00", monthlyRate: "1500.00", mileage: 25000, purchaseCost: "35000.00", insuranceCost: "1500.00", insuranceExpiryDate: new Date(now.getTime() + 180 * 24 * 60 * 60 * 1000), nextMaintenanceDate: new Date(now.getTime() + 20 * 24 * 60 * 60 * 1000), nextMaintenanceKm: 26000 },
    { userId, plateNumber: p("GHI-3456"), brand: "Hyundai", model: "Elantra", year: 2023, color: "White", category: "Economy" as const, status: "Available" as const, dailyRate: "35.00", weeklyRate: "220.00", monthlyRate: "800.00", mileage: 5000, purchaseCost: "20000.00", insuranceCost: "900.00", insuranceExpiryDate: new Date(now.getTime() + 200 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("JKL-7890"), brand: "BMW", model: "5 Series", year: 2022, color: "Gray", category: "Luxury" as const, status: "Maintenance" as const, dailyRate: "95.00", weeklyRate: "600.00", monthlyRate: "2200.00", mileage: 18000, purchaseCost: "55000.00", insuranceCost: "2500.00", insuranceExpiryDate: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("MNO-2345"), brand: "Nissan", model: "Altima", year: 2022, color: "Red", category: "Midsize" as const, status: "Rented" as const, dailyRate: "42.00", weeklyRate: "260.00", monthlyRate: "950.00", mileage: 12000, purchaseCost: "24000.00", insuranceCost: "1100.00", insuranceExpiryDate: new Date(now.getTime() + 60 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("PQR-6789"), brand: "Chevrolet", model: "Malibu", year: 2021, color: "Blue", category: "Midsize" as const, status: "Available" as const, dailyRate: "43.00", weeklyRate: "270.00", monthlyRate: "980.00", mileage: 22000, purchaseCost: "23000.00", insuranceCost: "1050.00", insuranceExpiryDate: new Date(now.getTime() + 120 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("STU-0123"), brand: "Mazda", model: "CX-5", year: 2023, color: "Silver", category: "SUV" as const, status: "Available" as const, dailyRate: "55.00", weeklyRate: "350.00", monthlyRate: "1300.00", mileage: 7000, purchaseCost: "30000.00", insuranceCost: "1400.00", insuranceExpiryDate: new Date(now.getTime() + 150 * 24 * 60 * 60 * 1000) },
    { userId, plateNumber: p("VWX-4567"), brand: "Kia", model: "Optima", year: 2022, color: "Black", category: "Midsize" as const, status: "Available" as const, dailyRate: "41.00", weeklyRate: "255.00", monthlyRate: "920.00", mileage: 14000, purchaseCost: "23500.00", insuranceCost: "1080.00", insuranceExpiryDate: new Date(now.getTime() + 45 * 24 * 60 * 60 * 1000), nextMaintenanceKm: 14500 },
    { userId, plateNumber: p("YZA-8901"), brand: "Mercedes-Benz", model: "C-Class", year: 2023, color: "White", category: "Luxury" as const, status: "Available" as const, dailyRate: "90.00", weeklyRate: "580.00", monthlyRate: "2100.00", mileage: 6000, purchaseCost: "50000.00", insuranceCost: "2300.00", insuranceExpiryDate: new Date(now.getTime() + 300 * 24 * 60 * 60 * 1000) },
  ];
